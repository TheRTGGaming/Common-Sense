...
public abstract class SteelArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 10, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_iron")), () -> Ingredient.of(new ItemStack(CommonSenseModItems.STEEL_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("common_sense:steelarmor"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("common_sense:steel_armor"), armorMaterial);
