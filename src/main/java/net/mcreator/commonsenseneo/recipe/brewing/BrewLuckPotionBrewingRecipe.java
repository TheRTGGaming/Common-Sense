...
@EventBusSubscriber
public class BrewLuckPotionBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new BrewLuckPotionBrewingRecipe());
	}
	...
	public boolean isIngredient(ItemStack ingredient) {
		return Ingredient.of(new ItemStack(CommonSenseModItems.CLOVER_LEAF.get())).test(ingredient);
	}
