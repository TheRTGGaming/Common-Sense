package net.mcreator.commonsenseneo.world.features;
...
import net.mcreator.commonsenseneo.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, CommonSenseMod.MODID);
